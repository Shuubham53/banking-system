...
import com.banking.account_service.error.InsufficientBalanceException;
...
public class AccountService {
    ...
    public AccountResponse updateBalance(String accountNumber, BigDecimal amount) {
        ...
        if (newBalance.compareTo(BigDecimal.ZERO) < 0) {
            throw new InsufficientBalanceException("Balance cannot go negative for account: " + accountNumber);
        }
        ...
        try {
            ...
            log.error("Concurrent update conflict for account: {}", accountNumber);
            throw new RuntimeException("Account was updated concurrently, please retry: " + accountNumber);
        }
