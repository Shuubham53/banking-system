...
public class CustomerController {
    ...
    public ResponseEntity<ApiResponse<CustomerResponse>> completeProfile(
        ...
        CustomerResponse response = customerService.completeProfile(userId,request);
        return ResponseEntity.status(HttpStatus.CREATED).body(ApiResponse.success("customer profile completed",response));
    }
